...
Keyword = 
[
"CppAD  A Package for Differentiation of C++ Algorithms: cppad-20071016.0   algorithmic automatic derivative version introduction require base type include cppad.hpp symbol preprocessor namespace",
"Install  CppAD Download, Test, and Installation Instructions  ",
"InstallSubversion  Using Subversion to Install CppAD  ",
"InstallUnix  Unix Download, Test, and Installation   cppad free configure prefix directory documentation introduction get_started exp_apx example more speed print forward mode profile std::vector postfix adolc fadbad boost compile flags",
"InstallWindows  Windows Download, Test, and Installation   free cppad getstarted introduction example more speed print forward mode speedtest",
...
"nan  Obtain Nan and Determine if a Value is Nan   isnan hasnan",
...
"speed_utility  Speed Testing: Main Program and Utilities  ",
"speed_main  Speed Test Main Program   cppad det_lu correct det_minor poly uniform_01",
...
"speed_adolc  The Adolc Speed Tests  ",
"adolc_det_minor.cpp  Adolc Speed: Gradient of Determinant Using Expansion by Minors   compute_det_minor correct_det_minor speed_det_minor",
"adolc_det_lu.cpp  Adolc Speed: Gradient of Determinant Using Lu Factorization   compute_det_lu correct_det_lu speed_det_lu",
"adolc_poly.cpp  Adolc Speed: Second Derivative of a Polynomial   compute_poly correct_poly speed_poly",
"speed_cppad  The CppAD Speed Tests  ",
"cppad_det_minor.cpp  CppAD Speed: Gradient of Determinant Using Expansion by Minors   compute_det_minor correct_det_minor speed_det_minor",
"cppad_det_lu.cpp  CppAD Speed: Gradient of Determinant Using Lu Factorization   compute_det_lu correct_det_lu speed_det_lu",
"cppad_poly.cpp  CppAD Speed: Second Derivative of a Polynomial   compute_poly correct_poly speed_poly",
"speed_fadbad  The Fadbad Speed Tests  ",
"fadbad_det_minor.cpp  Fadbad Speed: Gradient of Determinant Using Expansion by Minors   compute_det_minor correct_det_minor speed_det_minor",
"fadbad_det_lu.cpp  Fadbad Speed: Gradient of Determinant Using Lu Factorization   compute_det_lu correct_det_lu speed_det_lu",
"fadbad_poly.cpp  Fadbad Speed: Second Derivative of a Polynomial   compute_poly correct_poly speed_poly",
